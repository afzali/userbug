...
export default async function globalSetup() {
  ...
  await store.init({
    ...
    /**
     * نامِ بَنچ: اسمی که آدم روی این بار گذاشته.
     *
     * بی این، «سه سناریوی پیش از انتشار» و «همان سه بعد از تغییر» در فهرست
     * دو ردیفِ هم‌شکل با دو رشتهٔ تاریخ‌اند و تریاژ نمی‌تواند بگوید این
     * یافته از کدام بار است.
     */
