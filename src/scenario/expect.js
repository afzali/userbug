...
export function candidatesFor(target) {
   ...
   *
   * از `listPages` می‌آید و نه از خوانندهٔ واحد (`map/merge.js`)، چون اینجا
   * به **خودِ توصیف‌گرها** نیاز داریم نه به شمارششان: هر بند یک هدفِ واقعی
   * است که `resolveTarget` می‌فهمدش.
   *
