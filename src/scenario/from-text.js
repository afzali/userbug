...
- **یک استثنا**: بعد از نخستین "go" همیشه یک {"dismissBlockers": {"wait": 5000}} بگذار.
  این کارِ کاربر نیست، شرطِ رسیدن به کار است — خیلی از اپ‌ها در نخستین بازدید
  پنجره‌ای نشان می‌دهند (کوکی، بروزرسانی، خوش‌آمد) که روی همه‌چیز می‌نشیند و
  کلیکِ بعدی را می‌بلعد. اگر پنجره‌ای نباشد این قدم بی‌اثر است، پس گذاشتنش
  هیچ هزینه‌ای ندارد و نگذاشتنش سناریو را روی اپِ واقعی می‌شکند.`;
