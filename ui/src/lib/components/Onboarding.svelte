<script>
  ...
  const SLIDES = $derived([
    ...
    },
    {
      ...
      index: '۳',
      title: 'شناخت',
      why: 'هر چیزی که می‌دانیم، با اینکه از کجا آمده.',
      what: [
        'مسیرها، واژه‌ها، کارهای خطرناک — و کنارِ هر بند نوشته شده از کاربر آمده، از گشت، از سورس یا از مدل.',
    ...
    },
    {
      ...
      what: [
        ...
        '<strong>حساب و فایل</strong> (از صفحهٔ سناریوها): یوزر و رمزِ تست، و فایل‌هایی که سناریو آپلود می‌کند.',
      ],
      href: `${base}/files`,
      cta: 'سناریوها و تنظیمات',
    },
  ]);
