      ...
      ? [
          {
            ...
            items: [
              ...
              },
              {
                ...
                icon: '⌘',
                hint: 'نوشتن و ویرایش',
                title: 'فایل‌های سناریو و کانفیگ پروژه — دیدن، ویرایش، بازنویسی با هوش مصنوعی، و ساختِ سناریوی تازه از متنِ ساده.',
              },
              {
                href: `${base}/triage`,
                label: 'یافته‌ها',
            ...
            items: [
              {
                ...
                label: 'سورس',
                icon: '◱',
                hint: 'چه هست که نیازموده‌ایم',
                title: 'صفحه‌ها، endpointهای بک‌اند، و قاعده‌های schema — در برابر آنچه اجراها واقعاً لمس کرده‌اند. بی یک فراخوانی مدل.',
              },
              {
                href: `${base}/config`,
                label: 'پیکربندی',
                icon: '⚒',
                hint: 'حساب، فایل، چک',
                title: 'حساب‌های ذخیره‌شده، فایل‌هایی که سناریو آپلود می‌کند، چک‌های همگانی — و راهی به فایلِ پیکربندیِ خودِ پروژه.',
              },
            ],
          },
        ]
