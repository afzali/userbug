      ...
      ? [
          {
            ...
            items: [
              ...
              {
                /**
                 * ── چرا «دورها» و «اجرا» هر دو هستند ──
                 *
                 * دو پرسشِ متفاوت‌اند و قاطی کردنشان همان کشوی خرت‌وپرتی
                 * می‌شود که «پیکربندی» یک بار شد. «اجرا» یعنی همین حالا چه
                 * بگیرم؛ «دورها» یعنی بارِ گذشته چه دیدیم و این بار چه فرق
                 * کرد.
                 */
                href: `${base}/rounds`,
                label: 'دورها',
                icon: '◎',
                hint: 'هر بارِ بررسی، و تفاوتش',
                title: 'هر بارِ بررسی زیر یک اسم — با دامنه‌اش، روش‌هایش، و اینکه نسبت به دورِ قبل چه یافتهٔ تازه‌ای آمد و چه رفع شد.',
              },
              {
                href: `${base}/run`,
                label: 'اجرا',
                icon: '▶',
                hint: 'شروع، و تاریخچه',
                title: 'فرمِ اجرا با انتخابِ سناریو و دستگاه و مدل، زمان‌بندی، و تاریخچهٔ اجراها.',
              },
              {
                /**
                 * ── چرا دوباره «سناریوها» شد ──
                 *
