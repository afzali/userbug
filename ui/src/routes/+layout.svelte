      ...
      ? [
          {
            ...
            items: [
              ...
              },
              {
                 ...
                 * کدام را بزند — یکی فرم داشت، آن یکی می‌گفت «دورِ تازه از
                 * اپِ من شروع می‌شود». سه در برای یک کار، با شمردنِ دکمهٔ
                 * خودِ درخت.
                 *
                 * و نامش «بررسی» است نه «اجرا»: «اجرا» کارِ ابزار را می‌گوید،
                 * «بررسی» کاری را که آدم می‌کند.
                 */
                href: `${base}/rounds`,
                label: 'بررسی',
                icon: '▶',
          ...
          },
          {
            ...
            items: [
              ...
              {
                /**
                 * ── چرا «کشف» از منو بیرون رفت ──
                 *
                 * حذف نشد؛ جایش عوض شد. کشف یک **کار** است نه یک مقصد:
                 * جوابش درخت را پر می‌کند، و آدم وقتی سراغش می‌رود که به
                 * درخت نگاه کرده و دیده جایی کم است.
                 *
                 * پس از سرصفحهٔ همان درخت و از حالتِ خالی‌اش در دسترس است —
                 * دقیقاً جایی که نیاز به آن معلوم می‌شود. ردیفی که فقط برای
                 * «همه‌چیز در منو باشد» بماند، منو را دوباره به فهرستِ
                 * امکانات تبدیل می‌کند؛ همان چیزی که دو بار از آن فرار
                 * کرده‌ایم.
                 */
                href: `${base}/discover`,
                label: 'کشف',
                ...
                hint: counts
                  ? counts.pages || counts.states
                    ...
                    : 'هنوز چیزی کشف نشده'
                  : 'بگرد، ببین چه دارد',
                title: 'سه راهِ شناختنِ اپ — گشتِ زنده، خزش، و خواندنِ سورس. نتیجه‌اش در «اپِ من» دیده می‌شود.',
              },
              {
                /**
                 * ── چرا نامش عوض شد ──
